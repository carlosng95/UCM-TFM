...
from algorithms.detection.processing.detection_preprocessing import process_image
...
def prediction(request: Request):
    ...
    model_path = os.path.join(os.path.dirname(__file__), '..', 'algorithms', 'detection', 'models', 'cnn_1.h5')
